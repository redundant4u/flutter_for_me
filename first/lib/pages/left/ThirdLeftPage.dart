...
class ThirdLeftPage extends StatefulWidget {
  final int id;
  ThirdLeftPage(this.id);

  @override
  ThirdLeftPageState createState() => ThirdLeftPageState();
}

class ThirdLeftPageState extends State<ThirdLeftPage> with AutomaticKeepAliveClientMixin {
