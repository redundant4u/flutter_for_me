...
class FourthLeftPage extends StatefulWidget {
  final int id;
  FourthLeftPage(this.id);

  @override
  FourthLeftPageState createState() => FourthLeftPageState();
}

class FourthLeftPageState extends State<FourthLeftPage> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<double>>(
      future: getLeftGraphData(widget.id),
